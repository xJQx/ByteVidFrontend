    ...
    return (
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div id="header-content" className="text-center">
                <p className="text-3xl font-semibold leading-8 tracking-tight text-indigo-700 hover:text-indigo-500 sm:text-4xl dark:text-yellow-500 dark:hover:text-yellow-600"><Link to='/ByteVidFrontend/' relative='path'>ByteVid</Link></p>
