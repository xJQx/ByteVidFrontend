        ...
        <>
            <div className="flex justify-center mt-10 mx-3">
                <div className="max-w-2xl w-full bg-white rounded-lg border shadow-md dark:bg-gray-800 dark:border-gray-700">
                    {/* Tab Headers */}
                    <div className="text-sm font-medium text-center text-gray-500 rounded-t-lg divide-x divide-gray-200 sm:flex dark:divide-gray-600 dark:text-gray-400 overflow-hidden" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">
                    ...
                    <div id="fullWidthTabContent" className="border-t border-gray-200 dark:border-gray-600">
                        {tab === 'youtube-link' ? <YoutubeLinkTab handleErrorMessage={handleErrorMessage} /> :
                            tab === 'upload-file' ? <UploadFileTab handleErrorMessage={handleErrorMessage} /> :
                                <UuidTab handleErrorMessage={handleErrorMessage} />}
                    </div>
                </div>
            </div>
            {errorMessage ? 
